...
const webpackProdConfig = require('./build/webpack.config.prod.site');
...
exports.build = function(options) {
	...
	webpackProdConfig.output.path = resolveProject(docConfig.outputPath);

	webpackProdConfig.output.publicPath = docConfig.publicPath || '/';
